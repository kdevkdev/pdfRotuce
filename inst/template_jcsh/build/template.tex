...
\\
\noindent
{\fontsize{10}{12}\selectfont\setstretch{1.14}{\bfseries\color{color1}$string_keywords_heading$:} 
...
\begin{tcolorbox}[colframe=themecolor2, colback=themecolor2, sharp corners,boxsep=4mm,top=3.5mm,left=3.8mm,right=2.0mm]\sffamily
    ...
    $endfor$
\vskip 3mm{\raggedright\bfseries $abstracts.sidelangs.string_keywords_heading$}  $abstracts.sidelangs.keywords$ 
\end{tcolorbox}
\vspace{3mm}
$endfor$
$endif$
